...
from joker.harvester.harvester import Harvester
from joker.plotting.util import PlotInfo, parse_plot_info
from joker.protocols import harvester_protocol
from joker.protocols.farmer_protocol import FarmingInfo
from joker.protocols.harvester_protocol import Plot
from joker.protocols.protocol_message_types import ProtocolMessageTypes
from joker.server.outbound_message import make_msg
...
from joker.util.ints import uint8, uint32, uint64
from joker.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSJokerConnection
    ):
        """
