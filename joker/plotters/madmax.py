...
from joker.plotting.create_plots import resolve_plot_keys
from joker.plotters.plotters_util import run_plotter, run_command
...
def get_madmax_executable_path_for_ksize(plotters_root_path: Path, ksize: int = 30) -> Path:
...
def plot_madmax(args, joker_root_path: Path, plotters_root_path: Path):
