...
from joker.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta_introducer.jokercoin.org"
            testnet_dns_introducer = "dns-introducer-testnet.jokercoin.org"
            testnet = "testnet0"
            ...
            mainnet_port = "18444"
            mainnet_introducer = "introducer.jokercoin.org"
            mainnet_dns_introducer = "dns-introducer.jokercoin.org"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running joker services for changes to take effect")
