...
from joker.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from joker.util.path import path_from_root
from joker.util.ws_message import WsRpcMessage, create_payload_dict
from joker.wallet.cc_wallet.cc_wallet import CCWallet
from joker.wallet.derive_keys import master_sk_to_singleton_owner_sk
...
from joker.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from joker.wallet.util.trade_utils import trade_record_to_dict
...
from joker.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "joker_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "joker_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from joker.pools.pool_wallet_info import initial_pool_state_from_dict
