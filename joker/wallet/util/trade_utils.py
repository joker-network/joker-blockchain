...
from joker.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "joker" in cc_discrepancies:
                    cc_discrepancies["joker"] = cc_discrepancies["joker"] + diff
                else:
                    cc_discrepancies["joker"] = diff
