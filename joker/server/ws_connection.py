...
from joker.cmds.init_funcs import joker_full_version_str
from joker.protocols.protocol_message_types import ProtocolMessageTypes
from joker.protocols.protocol_state_machine import message_response_ok
from joker.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from joker.protocols.shared_protocol import Capability, Handshake
from joker.server.outbound_message import Message, NodeType, make_msg
from joker.server.rate_limits import RateLimiter
...
from joker.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from joker.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSJokerConnection:
    """
