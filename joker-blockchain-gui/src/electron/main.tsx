        ...
        submenu: [
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Joker-network/joker-blockchain/',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Joker-network/joker-blockchain/releases',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://ecopool.group/en/xjk');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Igi Pool' }),
            click: () => {
              openExternal('https://xjk.igipool.one');
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://lbank.info/exchange/xjk/usdt');
            },
          },
          {
