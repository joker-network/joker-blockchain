...
import { /* mojo_to_joker_string, */ joker_to_mojo } from '../../../util/joker';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_joker_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of joker in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Joker that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Joker that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send joker to coloured address. Please enter a joker
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'joker_addr://') {
    ...
    const amountValue = Number.parseFloat(joker_to_mojo(amount));
    const feeValue = Number.parseFloat(joker_to_mojo(fee));
