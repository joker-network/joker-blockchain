...
import { Card, CopyToClipboard, Flex, Table } from '@joker/core';
import type { Row } from '../core/components/Table/Table';
import {
  mojo_to_joker_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ...
        : mojo_to_joker_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => mojo_to_joker_string(row.fee_amount),
