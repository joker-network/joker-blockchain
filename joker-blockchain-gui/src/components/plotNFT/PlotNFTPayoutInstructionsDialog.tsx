              ...
              <Flex flexDirection="column" gap={2}>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    paid. By default this will be an XJK address, but it can be
                  ...
                  <Link
                    target="_blank"
                    href="https://github.com/Joker-network/pool-reference/blob/main/SPECIFICATION.md#payloadpayout_instructions"
                    noWrap
                  >
