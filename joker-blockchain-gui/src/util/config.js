...
global.daemon_rpc_ws = `wss://${self_hostname}:57000`;
...
function loadConfig(net) {
  try {
    // check if JOKER_ROOT is set. it overrides 'net'
    ...
    const daemon_port = lodash.get(config, 'ui.daemon_port', 57000); // jshint ignore:line
