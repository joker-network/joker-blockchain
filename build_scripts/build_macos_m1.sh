...
electron-installer-dmg dist/Flax-darwin-arm64/Flax.app Flax-$FLAX_INSTALLER_VERSION-arm64 \
...
# xcrun altool --notarize-app -f Flax-0.1.X.dmg --primary-bundle-id net.joker.blockchain -u username -p password
