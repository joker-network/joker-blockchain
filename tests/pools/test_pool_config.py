...
from joker.pools.pool_config import PoolWalletConfig
from joker.util.config import load_config, save_config, create_default_chives_config
...
def test_pool_config():
    ...
    create_default_chives_config(test_root, ["config.yaml"])
