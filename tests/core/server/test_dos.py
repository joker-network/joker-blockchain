...
from joker.protocols.shared_protocol import Handshake
from joker.server.outbound_message import make_msg, Message
from joker.server.rate_limits import RateLimiter
from joker.server.server import ssl_context_for_client
...
class TestDos:
    ...
    async def test_spam_tx(self, setup_two_nodes):
        ...
        ws_con: WSJokerConnection = list(server_1.all_connections.values())[0]
        ws_con_2: WSJokerConnection = list(server_2.all_connections.values())[0]
