...
async def disconnect_all_and_reconnect(server: JokerServer, reconnect_to: JokerServer) -> bool:
...
async def connect_and_get_peer(server_1: JokerServer, server_2: JokerServer) -> WSJokerConnection:
    """
