...
wallet_program_files = set(
    [
        ...
        "joker/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "joker/wallet/puzzles/lock.inner.puzzle.clvm",
        "joker/wallet/puzzles/p2_conditions.clvm",
        "joker/wallet/puzzles/p2_delegated_conditions.clvm",
        "joker/wallet/puzzles/p2_delegated_puzzle.clvm",
        "joker/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "joker/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "joker/wallet/puzzles/p2_puzzle_hash.clvm",
        "joker/wallet/puzzles/rl_aggregation.clvm",
        "joker/wallet/puzzles/rl.clvm",
        "joker/wallet/puzzles/sha256tree_module.clvm",
        "joker/wallet/puzzles/singleton_top_layer.clvm",
        "joker/wallet/puzzles/did_innerpuz.clvm",
        "joker/wallet/puzzles/decompress_puzzle.clvm",
        "joker/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "joker/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "joker/wallet/puzzles/block_program_zero.clvm",
        "joker/wallet/puzzles/test_generator_deserialize.clvm",
        "joker/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "joker/wallet/puzzles/p2_singleton.clvm",
        "joker/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "joker/wallet/puzzles/pool_member_innerpuz.clvm",
        "joker/wallet/puzzles/singleton_launcher.clvm",
        "joker/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["joker/wallet/puzzles/create-lock-puzzlehash.clvm", "joker/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "joker/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to joker/wallet/puzzles, but not added to `wallet_program_files`
        """
